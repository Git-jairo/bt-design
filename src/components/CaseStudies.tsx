      ...
      <div className="max-w-[1152px] mx-auto">
        ...
        <div className="flex items-end justify-between mt-3 mb-16 gap-4">
          ...
          <div className="hidden md:flex items-center gap-8 pb-1 shrink-0">
            <Link
              href="/case-studies"
              className="text-sm font-semibold text-ink/40 hover:text-ink transition-colors"
            >
              Browse catalogue →
            </Link>
            <p className="text-sm text-ink/40 font-helix-body">
              <span ref={csRef} className="font-semibold text-ink">
                {csCount}
              </span>{" "}
              published
            </p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          >
            <Link
              href="/hackathon26"
              className="group flex flex-col justify-between h-full rounded-[36px] bg-teal p-12 lg:p-14 text-white min-h-[420px]"
            >
              <div>
          ...
          <div className="flex flex-col gap-6">
            {COMING_SOON.map(({ title, tag }, i) => (
              ...
              >
                <div className="flex flex-col justify-between h-full rounded-[32px] bg-helix-gray p-10 min-h-[190px]">
                  <span className="text-xs uppercase tracking-[0.1em] text-ink/40 font-helix-body">
                    {tag}
                  </span>
                  <h3 className="font-helix-display text-2xl uppercase text-ink leading-tight">
                    {title}
                  </h3>
                </div>
              </motion.div>
