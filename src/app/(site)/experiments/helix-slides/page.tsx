    ...
    <div className="font-helix-body bg-screen min-h-screen">
      ...
      <section className="px-6 pb-32 max-w-[1152px] mx-auto">
        <div className="relative">
          {/* Vertical rule */}
          <div className="absolute left-[84px] top-0 bottom-0 w-px bg-ink/[0.08]" />
            ...
            {ENTRIES.map((entry, i) => (
              <article key={i} className="flex gap-8">
                ...
                <div className="w-[84px] shrink-0 flex flex-col items-end pt-1 pr-8 relative">
                  <span className="text-[11px] font-bold uppercase tracking-widest text-ink/35 whitespace-nowrap">
                    {entry.date}
                  </span>
                  {/* Dot on the rule */}
                  <div className="absolute right-0 top-[6px] translate-x-1/2 w-2.5 h-2.5 rounded-full bg-white border-2 border-ink/20" />
                </div>
                ...
                <div className="flex-1 min-w-0">
                  ...
                  {/* Meta */}
                  <h2 className="font-helix-display text-2xl uppercase text-ink mb-2">
                    {entry.title}
                  </h2>
                  <p className="text-ink/55 leading-relaxed text-sm mb-4">
                    {entry.description}
                  </p>
