        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {EXPERIMENTS.map((exp) => (
            <Link
              ...
              className="group relative flex flex-col bg-white border border-gray-950/[0.07] rounded-2xl p-8 hover:shadow-[0_8px_40px_rgba(36,36,36,0.1)] transition-all duration-300 hover:-translate-y-0.5"
            >
              {/* Status dot */}
              <div className="flex items-center justify-between mb-8">
                <span className="text-xs font-semibold uppercase tracking-[0.14em] text-gray-950/40">
                  {exp.date}
                </span>
                {exp.status === "live" && (
              ...
              <div className="flex-1">
                <p className="text-xs font-semibold uppercase tracking-[0.12em] text-gray-950/35 mb-1">
                  {exp.subtitle}
                </p>
                <h2 className="font-helix-display text-3xl uppercase text-gray-950 mb-4 group-hover:text-teal transition-colors">
                  {exp.label}
                </h2>
                <p className="text-gray-950/55 leading-relaxed text-sm">
                  {exp.description}
                </p>
              </div>
          ...
          <div className="flex flex-col bg-gray-950/[0.02] border border-dashed border-gray-950/[0.1] rounded-2xl p-8 items-center justify-center gap-3 min-h-[280px]">
